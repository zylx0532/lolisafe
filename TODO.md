...
* [ ] Descriptive upload progress. Upload speed. Also tell user which chunk is currently being uploaded, to avoid confusion when progress is "stops" when shifting to the next chunk.
